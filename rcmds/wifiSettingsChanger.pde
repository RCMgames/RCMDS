...
void setupWifiSettingsChanger(float x, float y) {
  ...
  redRecallWifiButton=new Button(x-width/12, y+height/6, width/20, color(150, 0, 0), color(200), null, 0, true, false, "recall");
  redSaveWifiButton=new Button(x-width/12, y+height/4, width/25, color(150, 0, 0), color(200), null, 0, true, false, "save");
  loadWifiHotspotSettingsButton=new Button(x, y+height/6, width/20, color(70, 5, 70), color(200), null, 0, true, false, "hotspot");
  blueRecallWifiButton=new Button(x+width/12, y+height/6, width/20, color(0, 0, 150), color(200), null, 0, true, false, "recall");
  blueSaveWifiButton=new Button(x+width/12, y+height/4, width/25, color(0, 0, 150), color(200), null, 0, true, false, "save");
}
